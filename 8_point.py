...
def load_imgs():
    far1  = plt.imread("rgb_image20.jpg")
    far2 = plt.imread('rgb_image48.jpg')
    return far1, far2
far1, far2 = load_imgs()
...
def main(uvMat):
    ...
    plot1(far1, f_mat, uvMat) 

    plot2(far2, f_mat, uvMat)
main(uvMat)
...
plot1(far1, f_hat, uvMat) 

#%%
plot2(far2, f_hat, uvMat2)
